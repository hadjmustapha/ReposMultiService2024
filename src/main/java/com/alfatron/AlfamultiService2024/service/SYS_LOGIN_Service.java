...
import com.alfatron.AlfamultiService2024.mapper.SYS_LOGIN_Mapper;
...
@Service
public class SYS_LOGIN_Service implements UserDetailsService{

    private SYS_LOGIN_Repository utilisateurRepository;
    private SYS_LOGIN_Mapper utilisateurMapper;
    private SYS_ROLE_Mapper roleMapper;
    private PasswordEncoder passwordEncoder;

    public SYS_LOGIN_Service(SYS_LOGIN_Repository utilisateurRepository, SYS_LOGIN_Mapper utilisateurMapper, SYS_ROLE_Mapper roleMapper, PasswordEncoder passwordEncoder) {
