...
public class RH_ODM {
    ...
    @OneToMany(mappedBy="odm", cascade = {CascadeType.PERSIST,CascadeType.MERGE,CascadeType.REFRESH})
    @JsonIgnore
    List<RH_ODM_LIGNES> details = new ArrayList<>();
    ...
    public List<RH_ODM_LIGNES> getDetails() {
        return details;
    }

    public void setDetails(List<RH_ODM_LIGNES> details) {
